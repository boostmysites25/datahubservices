        ...
        <div className="">
          ...
          <div className="flex items-center gap-3 mt-5">
            <Link
              ...
              className="w-[2rem] h-[2rem] rounded-full p-2 bg-secondary hover:bg-secondary/90 text-white hover:text-white hover:-translate-y-1 transition-all duration-300 flex justify-center items-center"
            >
              <Instagram size={20} />
            </Link>
            <Link
