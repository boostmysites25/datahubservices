  ...
  return (
    <section className="bg-secondary/5 ">
      <div className="wrapper py-[5rem] flex flex-col gap-5 items-center">
        ...
        >
          Creating Future-Ready Solutions Today
        </h2>
        <div className="mt-5 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {allServices.map((service) => (
            <div
              data-aos="fade-up"
              className="last:sm:col-span-2 last:sm:w-1/2 last:lg:col-span-3 last:lg:w-1/3 mx-auto bg-primary/20 rounded-lg p-5 flex text-center flex-col justify-between"
            >
