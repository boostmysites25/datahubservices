      ...
      <div className="wrapper grid md:grid-cols-2 items-center gap-7">
        <div className="flex flex-col items-start gap-5">
          ...
          <h2 data-aos="fade-up" className="heading-2 mx-0">
            Integrity at Our Core, <br /> Innovation in Our DNA
          </h2>
          <p data-aos="fade-up" className="desc">
            Our expertise spans multiple domains, empowering businesses of all
            sizes to leverage cutting-edge technologies in Web Development,
            Mobile App Solutions, E-Commerce Development, and Blockchain.
          </p>
          <div data-aos="fade-up" className="flex gap-5 mt-2">
            ...
            <div className="flex flex-col gap-2">
              <h6 className="text-xl font-semibold">Innovation & Excellence</h6>
              <p className="desc">
          ...
          <div data-aos="fade-up" className="flex gap-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="desc">
                Cultivating trust, nurturing relationships, and upholding
                accountability.
              </p>
            </div>
          </div>
