        ...
        >
          ...
          <div className="py-[3rem] px-5 bg-white/40 rounded-xl backdrop-blur-sm text-primary_text relative z-10">
            ...
            <p className="font-light max-w-[50rem] text-center mx-auto mt-3">
              Embark on a journey into the future of business, where innovation
              and responsibility converge, and success is rooted in trust. Let’s
              harness the power of AI together and turn your vision into a
