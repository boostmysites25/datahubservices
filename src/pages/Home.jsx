    ...
    <>
      ...
      <section className="h-screen relative text-primary_text">
        ...
        >
          ...
          <h1 className="heading capitalize">
            Cutting-Edge IT Solutions <br /> for the Digital Age
          </h1>
          <p className="sub-heading">
            Smart Solutions, Strong Ethics – Driving Innovation with Integrity
          </p>
        </div>
      </section>
      <div
      ...
      >
        <div className="bg-primary/90 rounded-lg text-white p-5">
          ...
          <p className="desc">
            We go beyond websites, crafting advanced and fully functional web
        ...
        <div className="bg-primary/90 rounded-lg text-white p-5">
          ...
          <p className="desc">
            Our development team specializes in crafting intuitive, feature-rich
            mobile applications that deliver a seamless user experience,
            ensuring users stay engaged and satisfied with every interaction.
          </p>
        </div>
        <div className="bg-primary/90 rounded-lg text-white p-5">
          <div className="flex items-center gap-3 mb-4">
          ...
          <p className="desc">
            From startups to enterprise-level projects, we develop custom
            blockchain solutions that enhance security, streamline operations,
            and revolutionize digital transactions.
          </p>
        </div>
      </div>
      <section className="">
            ...
            >
              <div className="flex flex-col items-center lg:items-start gap-5 text-center lg:text-start">
                ...
                <p className="desc">
                  ...
                  in an increasingly digital world. Whether you're looking to
                  build custom blockchain solutions, develop a high-performance
                  app, or utilize the power of AI and data science, we are your
                  trusted partner in digital innovation. Our team of experts is
                  committed to delivering tailored solutions that meet your
                  business goals and drive success.
                </p>
              </div>
